...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x03655): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x0367d): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x036a5): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x036cd): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x036f5): "AsyncGeneratorYieldResolveSharedFun",
  ("old_space", 0x0371d): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x03745): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x0376d): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x03795): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x037bd): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x037e5): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0380d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x03835): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x0385d): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x03885): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x038ad): "PromiseCatchFinallySharedFun",
  ("old_space", 0x038d5): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x038fd): "PromiseThenFinallySharedFun",
  ("old_space", 0x03925): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x0394d): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x03975): "ProxyRevokeSharedFun",
}
