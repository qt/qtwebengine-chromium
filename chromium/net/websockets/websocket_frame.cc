...
const uint8_t kFinalBitWF = 0x80;
const uint8_t kReserved1BitWF = 0x40;
const uint8_t kReserved2BitWF = 0x20;
const uint8_t kReserved3BitWF = 0x10;
const uint8_t kOpCodeMaskWF = 0xF;
const uint8_t kMaskBitWF = 0x80;
