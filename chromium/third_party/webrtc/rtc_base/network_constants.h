...
constexpr uint16_t kNetworkCostCellular5GVpnSlice =  // 249
    static_cast<uint16_t>(kNetworkCostCellular5G + kNetworkCostVpn + kNetworkCostSlice);
...
constexpr uint16_t kNetworkCostCellularVpnSlice =  // 899
    static_cast<uint16_t>(kNetworkCostCellular + kNetworkCostVpn + kNetworkCostSlice);
