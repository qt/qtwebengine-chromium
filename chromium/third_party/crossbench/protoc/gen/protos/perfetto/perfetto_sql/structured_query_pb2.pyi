...
class PerfettoSqlStructuredQuery(_message.Message):
    __slots__ = ("id", "referenced_modules", "table", "sql", "simple_slices", "inner_query", "inner_query_id", "interval_intersect", "filters", "group_by", "select_columns")
    ...
    class GroupBy(_message.Message):
        ...
        class Aggregate(_message.Message):
            __slots__ = ("column_name", "op", "result_column_name", "percentile")
            ...
            percentile: float
            def __init__(self, column_name: _Optional[str] = ..., op: _Optional[_Union[PerfettoSqlStructuredQuery.GroupBy.Aggregate.Op, str]] = ..., result_column_name: _Optional[str] = ..., percentile: _Optional[float] = ...) -> None: ...
        COLUMN_NAMES_FIELD_NUMBER: _ClassVar[int]
