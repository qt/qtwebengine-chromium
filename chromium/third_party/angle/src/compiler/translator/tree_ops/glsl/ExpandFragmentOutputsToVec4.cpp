                  ...
                  TIntermSequence *postMain)
{
    ...
    (*replacedOutputs)[&variable] = global;
                                               ...
                                               TSymbolTable *symbolTable)
{
    ...
    if (!postMain.empty())
    {
        auto postMainBlock = new TIntermBlock;
        postMainBlock->replaceAllChildren(std::move(postMain));
        return RunAtTheEndOfShader(compiler, root, postMainBlock, symbolTable);
    }
    return true;
}
