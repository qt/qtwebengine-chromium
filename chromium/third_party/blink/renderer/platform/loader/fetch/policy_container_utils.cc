...
WebPolicyContainerPolicies ToWebPolicyContainerPolicies(
  ...
  web_policies.allow_cross_origin_isolation =
...
mojom::blink::PolicyContainerPoliciesPtr FromWebPolicyContainerPolicies(
  ...
  return mojom::blink::PolicyContainerPolicies::New(
      ...
      WTF::ToVector(policies.content_security_policies,
...
network::mojom::blink::CSPHashSourcePtr ConvertHashSourceToMojoBlink(
    const WebCSPHashSource& hash_source) {
  return network::mojom::blink::CSPHashSource::New(
   hash_source.algorithm, WTF::ToVector(hash_source.value));
}
...
network::mojom::blink::CSPSourceListPtr ConvertSourceListToMojoBlink(
  ...
  return network::mojom::blink::CSPSourceList::New(
      WTF::ToVector(source_list.sources, ConvertSourceToMojoBlink),
      Vector<String>(source_list.nonces),
      WTF::ToVector(source_list.hashes, ConvertHashSourceToMojoBlink),
