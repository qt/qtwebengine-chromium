...
#elif defined(_MSC_VER) && !defined(__clang__) && (defined(_M_ARM) || defined(_M_ARM64)) || BITCASTS_HAS_BUILTIN(_CopyFloatFromInt32))
...
#elif defined(_MSC_VER) && !defined(__clang__) && (defined(_M_ARM) || defined(_M_ARM64)) || BITCASTS_HAS_BUILTIN(_CopyInt32FromFloat))
