...
std::unique_ptr<Transaction> TransactFromQRCode(
  ...
  return std::make_unique<CTAP2Processor>(
      std::make_unique<TunnelTransport>(
          protocol_revision, platform_ptr, std::move(network_context_factory), qr_secret,
...
std::unique_ptr<Transaction> TransactFromQRCodeDeprecated(
  ...
  NetworkContextFactory factory = base::BindRepeating(
      ...
      network_context);
  return TransactFromQRCode(protocol_revision, std::move(platform), std::move(factory),
...
std::unique_ptr<Transaction> TransactFromFCM(
  ...
  return std::make_unique<CTAP2Processor>(
      std::make_unique<TunnelTransport>(
          protocol_revision, platform_ptr, std::move(network_context_factory), paired_secret,
...
std::unique_ptr<Transaction> TransactFromFCMDeprecated(
  ...
  NetworkContextFactory factory = base::BindRepeating(
      ...
      network_context);
  return TransactFromFCM(protocol_revision, std::move(platform), std::move(factory), root_secret,
