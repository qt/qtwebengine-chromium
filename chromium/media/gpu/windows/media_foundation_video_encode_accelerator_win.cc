...
HRESULT MediaFoundationVideoEncodeAccelerator::InitializeD3DVideoProcessing(
  ...
  D3D11_VIDEO_PROCESSOR_CONTENT_DESC vp_desc;
      ...
      vp_desc.OutputWidth = input_visible_size_.width();
      vp_desc.OutputHeight = input_visible_size_.height();
  ...
  D3D11_TEXTURE2D_DESC scaled_desc;
      scaled_desc.Width = input_visible_size_.width();
      scaled_desc.Height = input_visible_size_.height();
